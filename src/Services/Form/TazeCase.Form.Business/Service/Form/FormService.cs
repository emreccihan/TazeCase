...
{
    public class FormService : GenericService<Core.Entities.Form,FormInputDto,FormOutputDto>,IFormService
    {
        ...
        //}
        public FormService(IFormRepository formRepository, IMapper mapper)
            : base(formRepository, mapper) // GenericService'in constructor'ını çağırıyoruz
        {
            this.formRepository = formRepository;
            this.mapper = mapper;
        }
